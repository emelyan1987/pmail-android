...
public class MaterialCalendarView extends FrameLayout {
    ...
    private final MonthView.Callbacks monthViewCallbacks = new MonthView.Callbacks() {
        ...
        public void onDateChanged(CalendarDay date) {
            setSelectedDate(date.getDate(), true);
            if (listener != null) {
    ...
    public void setDayClicked(boolean state) {
        isClicked = state;
    }
     ...
     */
    public void setSelectedDate(Date date, boolean isClicked) {
        MaterialCalendarView.this.isClicked = isClicked;
