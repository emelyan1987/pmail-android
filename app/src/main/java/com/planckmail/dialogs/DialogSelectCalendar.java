...
import com.planckmail.adapters.SelectDefaultCalendar;
 ...
 */
public class DialogSelectCalendar  extends DialogFragment {
    private RecyclerView mRecycleSelectTime;
    private SelectDefaultCalendar mAdapter;
    private ISelectCalendar mListener;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        getDialog().setTitle(getString(R.string.calendars));
    ...
    public void setListener(ISelectCalendar listener) {
        mListener = listener;
    }
    ...
    private void setDialogAdapter() {
        ...
        mAdapter = new SelectDefaultCalendar(getActivity(), position,list);
        ...
        mRecycleSelectTime.addOnItemTouchListener(
                new RecyclerItemClickListener(getActivity(), new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        if (mListener != null)
                            mListener.selectCalendar(time, position);
    ...
    public interface ISelectCalendar {
        void selectCalendar(String calendar, int position);
    }
}
